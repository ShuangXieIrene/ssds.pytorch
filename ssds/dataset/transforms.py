...
class Expand(object):
    def __init__(self, mean=0, max_expand_ratio=2):
        """
        Args:
            max_expand_ratio: Ratio of canvas size to input size, must be > 1.
        """
        self.mean = mean
    ...
    def __call__(self, image, boxes, labels):
        ...
        ratio = random.uniform(1, self.max_expand_ratio)
...
class PhotometricDistort(object):
    def __init__(self, hue_delta=18., bri_delta=32, 
        ...
        self.pd = [
            ...
            # RandomSaturation(*saturation_range),
            # RandomHue(delta=hue_delta),
            # ConvertColor(current='HSV', transform='BGR'),
            # RandomContrast(*contrast_range)
        ]
        self.rand_brightness = RandomBrightness(delta=bri_delta)
